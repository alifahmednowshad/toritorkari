...
const Footer = () => {
    return (
      <div className="bg-base-200">
        <footer className="container mx-auto footer py-12 text-base-content">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div>
              <nav>
                ...
                <a className="link link-hover">About Our Shop</a>
            ...
            <div>
              <form>
                ...
                <fieldset className="form-control w-80 mt-3">
                  <div className="join">
                    <input
                      type="text"
        ...
        <footer className="footer footer-center px-10 py-4 border-t text-base-content border-base-300">
